...
class VerifyPaymentIntentTest extends TestCase
{
    ...
    public function test_verify_payment_intent(): void
    {
        ...
        $response = $this->actingAs($this->buyer)->postJson('/larashop/api/products/' . $deal->product_id . '/deal/payment_intent/verify', [
    ...
    public function test_verify_payment_intent_with_seller(): void
    {
        ...
        $response = $this->actingAs($this->seller)->postJson('/larashop/api/products/' . $deal->product_id . '/deal/payment_intent/verify', [
            'payment_intent_id' => $this->faker->text(20),
        ]);
