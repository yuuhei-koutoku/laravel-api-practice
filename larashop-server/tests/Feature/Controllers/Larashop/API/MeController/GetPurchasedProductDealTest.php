...
namespace Tests\Feature\Controllers\Larashop\API\MePurchasedProductController;
...
class GetPurchasedProductDealTest extends TestCase
{
    ...
    public function test_get_purchased_product_deal(): void
    {
        ...
        $response = $this->actingAs($buyer)->getJson('/larashop/api/me/purchased_products/' . $product->id . '/deal');
    ...
    public function test_get_purchased_product_deal_not_found(): void
    {
        ...
        $response = $this->actingAs($user)->getJson('/larashop/api/me/purchased_products/0/deal');
