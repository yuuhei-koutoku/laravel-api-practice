import type { Deal, PaginationMeta, DealPagination  } from '@/types/responseType'
...
const dealPagination: DealPagination = {
  data: { deals: deals },
  meta: meta
}

export default function handler(_req, res) {
  const snakeCaseResponseJson = humps.decamelizeKeys(dealPagination);
