...
export default function AvatarDropdown() {
  ...
  if (authUser === null) {
    return <div className="AvatarDropdown"></div>
  }
                ...
                <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      <Avatar sizeClass="w-12 h-12" imgUrl={authUser?.profileImageUrl ?? undefined} />

                      <div className="flex-grow">
                        <h4 className="font-semibold">{authUser.nickname}</h4>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium ">{"マイページ"}</p>
                      </div>
                    </Link>
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium ">{"出品"}</p>
                      </div>
                    </Link>
